...
// 环境变量
const UUID = process.env.UUID || '11456d0d-c98e-4aeb-9aab-37f64edd5710'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const DOMAIN = process.env.DOMAIN || 'kads2-app.hf.space';                   // 域名或ip,留空将自动获取服务器ip
